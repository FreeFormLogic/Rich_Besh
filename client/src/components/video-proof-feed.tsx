...
const sampleAds: AdContent[] = [
  {
    id: "ad1",
    title: "🔥 1xBet - Получи 25,000₽ бонус!",
    description: "Эксклюзивное предложение для подписчиков Rich Besh. Удвой свой первый депозит!",
  ...
  {
    id: "ad2", 
    title: "⚡ Parimatch - Кэшбэк 10%",
    description: "Лучшие коэффициенты + еженедельный кэшбэк. Начни зарабатывать уже сегодня!",
  ...
  return (
    <div className="neubrutalism-card bg-gradient-to-br from-rich-gold/10 to-rich-black rounded-2xl overflow-hidden border border-rich-gold/30 animate-slide-up">
      <div className="relative">
        ...
        />
        <div className="absolute top-4 left-4 bg-rich-gold text-black px-3 py-1 rounded-full font-bold text-xs">
          РЕКЛАМА
        </div>
      </div>
